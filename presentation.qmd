...
Overall, I would suggest that it is worthwile for local policy makers across boroughs to identify which complaints are most common in their area and allocate resources accordingly in order to save time and money. In addition to this, based on the significance of demographic variables, I think further reasearch could be done to associate specific complaints to specific demographics and utilize that information accordingly.